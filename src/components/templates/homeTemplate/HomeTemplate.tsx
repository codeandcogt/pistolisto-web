...
export default function HomeTemplate() {
  ...
  return (
    <div
      ref={containerRef}
      className="h-screen bg-gradient-to-tr from-black via-transparent to-green-900"
    >
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/50 backdrop-blur-md border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="nav-item text-2xl font-bold text-primary mr-2">
            <Image
              src="/svg/logo.svg"
              alt="Logo"
              width={80}
      ...
      <section className="flex items-center justify-center min-h-screen px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center">
            <h1 className="hero-title text-5xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight"></h1>
          </div>
        </div>
      </section>
    </div>
